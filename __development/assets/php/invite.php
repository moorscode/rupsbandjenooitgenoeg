...
<table width="100%">
<tr>
	<td align="right">Naam:</td><td><input type="text" name="naam" maxlength="64" /></td>
</tr><tr>
	<td align="right">Emailadres:</td><td><input type="text" name="email" maxlength="64" /></td>
</tr>
</table>
<br>

Je kan ook persoonlijk iemand uitnodigen om zich te registreren met deze code:<br>
<input type="text" value="http://www.rupsbandjenooitgenoeg.nl/?invite=<?= $invite_code ?>" size="50" onfocus="this.select();" onclick="this.select();" onchange="this.value='http://www.rupsbandjenooitgenoeg.nl/?invite=<?= $invite_code ?>';" onkeyup="this.value='http://www.rupsbandjenooitgenoeg.nl/?invite=<?= $invite_code ?>';" />
<br>
<br>

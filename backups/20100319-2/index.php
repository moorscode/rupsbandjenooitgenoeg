...
if(isset($_GET['action'])) {
	...
	if($action == "passwordreset") {
		...
		$query = $db->query("SELECT `id`, `username` FROM `global__Players` WHERE MD5(CONCAT(`invite_code`, `email`))='$code'");
...
<?php
		...
		<br />
		Als je bent ingelogged kan je ook tegen andere mensen spelen!
		<br /><br />

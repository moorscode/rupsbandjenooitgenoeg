...
if($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if($password != "") {
		if($password2 == $password) {
			...
			push_message("Wachtwoorden komen niet overeen, je profiel kan niet opgeslagen worden!");
			die("{'saved':false}");
		}
	}
...
if($user = $db->assoc($query)) {
	...
	logout();
	die("Er is een fout opgetreden.<br />Je wordt nu uitgelogged, hierna kan je opnieuw inloggen en het opnieuw proberen.<br />Excuses voor het ongemak.");
}
...
<tr>
	...
	<td align="center" colspan="2"><br />Wijzig wachtwoord<br />&nbsp;</td>
</tr><tr>

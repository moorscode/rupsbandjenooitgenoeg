...
<div id="body">
	...
	<div id="mainHolder" style="padding: 10px; width: 430px; height: 280px">
		...
		<div><img id="chatStatus" src="assets/html/images/<?= (isset($chat_id)?"online":"offline") ?>.gif" width="12" height="11" /> &nbsp;Chat Server</div>
		<div><img id="chatStatus" src="assets/html/images/<?= (isset($game_id)?"online":"offline") ?>.gif" width="12" height="11" /> &nbsp;Game Server</div>
		<br />

		<div>
			<input type="button" name="chatControl" value=" <?= (isset($chat_id)?"kill":"start") ?> " onclick="location.href='admin.php?do=<?= (isset($chat_id)?"kill":"start") ?>&what=chat';" /> Chat Server<br />
			<input type="button" name="chatControl" value=" <?= (isset($game_id)?"kill":"start") ?> " onclick="location.href='admin.php?do=<?= (isset($game_id)?"kill":"start") ?>&what=game';" /> Game Server 
		</div>
	</div>

...
if( isset($_SESSION['mail_send']) ) {
	echo ($_SESSION['mail_send'])?"Mail send.":"Mail sending failed.";
...
?>
	...
	<tr>
		<td>Titel:</td>
		<td><input type="text" name="subject" autocomplete="no" size="70" /></td>
	</tr>
	<tr>
		<td valign="top">Mail:</td>
		<td><textarea rows="10" cols="68" name="body"></textarea></td>
	</tr>
	<tr>
		<td></td>

...
class DisplayStatistics {
	...
	public function DisplayStatistics($table, $prefix = 'stats__') {
		...
		$this->item(null, 'context_menu', null, array('full_screen'=>'true', 'about'=>'false', 'print'=>'false'));
		...
		$this->item(null, 'chart_guide', null, array('horizontal'=>'true',
																	'vertical'=>'false',
																	'thickness'=>1, 
																	'color'=>'ff4400',
																	'alpha'=>75,
		...
		$this->item(null, 'axis_value', null, array('prefix'=>'',
																  'suffix'=>'',
																  'decimals'=>0,
																  'decimal_char'=>'.',
																  'seperator'=>'',
		...
		$this->item(null, 'axis_category', null, array('font'=>'arial',
																  		'size'=>9,
																  		'bold'=>'true',
																  		'color'=>'000000',
																  		'alpha'=>90,
	...
	public function item($target, $name, $value = null, $attributes = null) {
		$index = array_push($this->values, array("target"=>$target, "name"=>$name, "value"=>$value, "attributes"=>$attributes)) - 1;
		return $index;
	}
	...
	public function dataset($title, $parameter = null, $customHandleFunction = null) {
		...
		array_push($this->datasets, array("title"=>$title, "parameter"=>$parameter, "customHandleFunction"=>$customHandleFunction, "results"=>array(), "data"=>''));
	}

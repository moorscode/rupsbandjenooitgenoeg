...
if($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	$username = htmlentities($username, ENT_NOQUOTES, "ISO8859-15");
...
?>
<center><h2>Beheer je profiel</h2></center>
<br />
<table width="100%" cellspacing="0" cellpadding="2">
<tr>
	<td width="30%" align="right">Alias:&nbsp;</td>
	<td><input type="text" name="username" value="<?= html_entity_decode($username, ENT_NOQUOTES); ?>" maxlength="64" /></td>
</tr><tr>

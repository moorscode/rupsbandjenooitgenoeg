...
if(stristr($_SERVER["SERVER_NAME"], "www.") === false) {
	header("Location: http://www.rupsbandjenooitgenoeg.nl/");
	die();
}
*/
...
<?php
	if($_SESSION['user_id'] != 1) {
		...
		?>
		<br />
		<div class="menuItem disabled" onclick="">prestaties</div>
		<br />
...
<?php
		...
		<div class="menuItem" onclick="location.href='admin.php';">server beheer</div>
<?php
	} ?>
		<br />
